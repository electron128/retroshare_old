...
int main(int argc, char **argv)
{
	...
	as >> option('X',"enable-ssh"     ,enableSsh        ,"Enable SSH"        )
       ...
       >> parameter(0 , "mmi"            ,mmiCommand    ,"command", "execute command, run \"--mmi help\" for a list of commands", false  )
    ...
    if (!mmiCommand.empty())
    {
        return executeMMICommand(mmiCommand, argc, argv);
    }
